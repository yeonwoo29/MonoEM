...
class translatormodel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            ## HYPER-PARAMETER FOR translator
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:
            ...
            ########################
            self.gradientloss = networks.GradientLoss()
    ...
    def forward(self):
        ...
        ############
        self.rec_B = self.netG_A(self.fake_A, self.latent_real_B)
    ...
    def backward_G(self):
        ...
        #############################
        self.gradientloss_loss_A = self.gradientloss(self.rec_A, self.real_A)
        self.gradientloss_loss_B = self.gradientloss(self.rec_B, self.real_B)
        #############################
        ...
        self.loss_G = self.loss_G_A + self.loss_G_B + self.loss_cycle_A + self.loss_cycle_B + self.loss_idt_A + self.loss_idt_B + self.loss_regularization_G_B + self.loss_consistency_B + self.gradientloss_loss_A + self.gradientloss_loss_B
